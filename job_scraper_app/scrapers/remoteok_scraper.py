"""
RemoteOK Scraper for the Job Scraper Application.

This module implements a scraper for the RemoteOK job site.
"""
...
class RemoteOkScraper(BaseScraper):
    ...
    def scrape(self):
        ...
        try:
            ...
            # Get the page content (RemoteOK uses JavaScript to load content, so we need Selenium)
            soup = self._get_page_content(url, use_selenium=True)
            ...
            for container in job_containers:
                try:
                    ...
                    # For RemoteOK, the description is often included in the listing page
                    description_elem = container.select_one(self.site_config["selectors"]["description_selector"])
                    if description_elem:
                        ...
                        # If description is not in the listing page, fetch it from the job page
                        try:
            ...
            logger.info(f"Scraped a total of {len(job_listings)} job listings from RemoteOK")
    ...
    def _extract_company_website(self, text):
        ...
        if urls:
            ...
            excluded_domains = ['remoteok.com', 'linkedin.com', 'twitter.com', 'facebook.com', 'instagram.com']
            for url in urls:
